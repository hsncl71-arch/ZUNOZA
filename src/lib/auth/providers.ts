...
/** Direct Apple Sign In (Service ID / key) — not brokered through Grok. */
export const APPLE_SIGN_IN: GrokProvider = {
  providerId: "grok-apple",
  idp: "apple",
  label: "Apple",
};

export const SIGN_IN_PROVIDERS: readonly GrokProvider[] = [
  GROK_PROVIDERS[0],
  APPLE_SIGN_IN,
  GROK_PROVIDERS[1],
];
